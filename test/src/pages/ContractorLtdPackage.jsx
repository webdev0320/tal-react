    ...
    <div className="bg-light">
      ...
      <header className="position-relative text-white overflow-hidden py-5" style={{ background: 'linear-gradient(135deg, #1d3c45 0%, #11252b 100%)' }}>
        <div className="container position-relative py-4 text-center text-lg-start" style={{ zIndex: 2 }}>
          <span className="text-uppercase small fw-bold mb-2 d-inline-block text-brand-orange" style={{ letterSpacing: '2px' }}>
            Contractor - LTD Pricing
          </span>
          ...
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb justify-content-center justify-content-lg-start mb-0 small" style={{ background: 'transparent' }}>
              ...
              <li className="breadcrumb-item"><Link to="/packages" className="text-decoration-none text-brand-orange">Packages</Link></li>
              <li className="breadcrumb-item active text-white-50" aria-current="page">Contractor – LTD – pricing</li>
            </ol>
          </nav>
        </div>
      </header>
          ...
          <div className="row g-4 justify-content-center">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card h-100 border-0 shadow-sm rounded-4 p-4 service-card position-relative">
                <div className="text-center mb-4">
                  ...
                  <p className="text-muted small mb-0">Turnover</p>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card h-100 border-0 shadow rounded-4 p-4 service-card position-relative" style={{ borderTop: '4px solid var(--brand-orange)' }}>
                <div className="position-absolute top-0 end-0 bg-danger text-white px-3 py-1 fw-bold small shadow-sm" style={{ borderBottomLeftRadius: '10px', borderTopRightRadius: '10px' }}>
                  Sale
                </div>
                <div className="text-center mb-4">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card h-100 border-0 shadow-sm rounded-4 p-4 service-card position-relative">
                ...
                <div className="text-center mb-4">
                  ...
                  <p className="text-muted small mb-0">Turnover</p>
                  <div className="d-flex justify-content-center align-items-baseline mt-1">
                    <span className="fs-1 fw-bold text-brand-orange">£78</span>
                    <span className="text-muted ms-1">+VAT / m</span>
                  </div>
                </div>
                <ul className="list-unstyled text-secondary mb-4 d-flex flex-column gap-3" style={{ fontSize: '0.95rem' }}>
...
export default ContractorLtdPackage;
