      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <a href="tel:+440000000000" className="px-3 py-2 text-sm !bg-[#d2601a] text-white rounded-full flex items-center justify-center gap-2 hover:!bg-[#b55216] transition-all duration-200 hover:-translate-y-0.5 shadow-md w-max">
